...
# host_indiv<-read.csv(Indiv_path, stringsAsFactors = FALSE, na.strings=c("", " ", NA))
...
HH_with_composite<-HH_yes_consent %>% left_join(composite_indicators,by="X_uuid")

HH_with_composite<-butteR::remove_concat_select_multiple(HH_with_composite,questionnaire = HH_kobo_questionnaire)

# debugonce(recode_SNFI_severity_bgd2019)
