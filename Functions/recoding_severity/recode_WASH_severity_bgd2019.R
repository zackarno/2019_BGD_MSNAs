  ...
  if(population=="Refugee"){
   hh_data<- hh_data %>% 
      mutate(
        ...
        # int.wash.sub.living_standards.sanitation.s4 = ,
        ...
        int.wash.sub.living_standards.sanitation=if_else(int.wash.sub.living_standards.sanitation.s6==1,6,
                                            if_else(int.wash.sub.living_standards.sanitation.s5==1,5,
                                                            if_else(int.wash.sub.living_standards.sanitation.s3==1, 3,
   ...
   hh_data<-hh_data %>% 
     mutate(
       ...
       int.wash.improved_water_drinking= water_source_drink.tubewells | water_source_drink.protected_spring|
         water_source_drink.cart_small_tank| water_source_drink.protected_dugwell,
       
       int.wash.improved_water_wash= water_source_wash.tubewells | water_source_wash.protected_spring|
         water_source_wash.cart_small_tank| water_source_wash.protected_dugwell,
       ...
       int.wash.sub.living_standards.water_source.s2 =int.wash.drnk_pipe_wash_pipe & 
          int.wash.time_greater_30_min==0,
        
        int.wash.sub.living_standards.water_source.s3= (int.wash.drnk_pipe_wash_pipe==1 | (int.wash.improved_water_wash& int.wash.improved_water_drinking ))&
         int.wash.time_greater_30_min==0 ,
        
        int.wash.sub.living_standards.water_source.s4=(int.wash.drnk_pipe_wash_pipe==1 | (int.wash.improved_water_wash& int.wash.improved_water_drinking )) & 
       ...
       index.wash.unsafe_male = if_else(feel_unsafe_male.latrine| feel_unsafe_male.water_points| feel_unsafe_male.bathing_areas| 
                 feel_unsafe_male.distribution_points|feel_unsafe_male.way_to_facilities,2,if_else(
                   feel_unsafe_male.market|feel_unsafe_male.market,1,0)),
